...
<table width="75%" border="1">
  ...
  <jsp:useBean id="cart" scope="session" class="com.sarvah.DTO.CartBean" />
 ...
 <br/>         <input type="submit" name="action" value="Delete"></font></td>
  ...
  <tr> 
    <td colspan="2"> </td>
    <td> </td>
    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Subtotal: $<c:out value="${cart.orderTotal}"/></font></td></tr>
